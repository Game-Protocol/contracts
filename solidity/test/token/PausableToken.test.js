...
contract('PausableToken', function ([_, owner, recipient, anotherAccount]) {
    ...
    describe('when the sender is the token owner', function () {
      ...
      describe('when the token is paused', function () {
        ...
        it('reverts', async function () {
          await assertRevert.assertRevert(this.token.pause({ from }));
        });
      });
    });
  ...
  describe('unpause', function () {
    describe('when the sender is the token owner', function () {
      ...
      describe('when the token is unpaused', function () {
        it('reverts', async function () {
          await assertRevert.assertRevert(this.token.unpause({ from }));
        });
      });
    });
  ...
  describe('pausable token', function () {
    ...
    describe('transfer', function () {
      ...
      it('reverts when trying to transfer when paused', async function () {
        ...
        await assertRevert.assertRevert(this.token.transfer(recipient, 100, { from: owner }));
      });
    });
    ...
    describe('approve', function () {
      ...
      it('reverts when trying to transfer when paused', async function () {
        ...
        await assertRevert.assertRevert(this.token.approve(anotherAccount, 40, { from: owner }));
      });
    });
    ...
    describe('transfer from', function () {
      ...
      it('reverts when trying to transfer from when paused', async function () {
        ...
        await assertRevert.assertRevert(this.token.transferFrom(owner, recipient, 40, { from: anotherAccount }));
      });
    });
    ...
    describe('decrease approval', function () {
      ...
      it('reverts when trying to transfer when paused', async function () {
        ...
        await assertRevert.assertRevert(this.token.decreaseApproval(anotherAccount, 40, { from: owner }));
      });
    });
    ...
    describe('increase approval', function () {
      ...
      it('reverts when trying to increase approval when paused', async function () {
        ...
        await assertRevert.assertRevert(this.token.increaseApproval(anotherAccount, 40, { from: owner }));
      });
    });
  });
});
